...
namespace Earth.Renderer
{
    ...
    {
        public static ImageDatatype ImagingPixelFormatToDatatype(UnityEngine.TextureFormat pixelFormat)
        {
        ...
        private static bool Supported(UnityEngine.TextureFormat pixelFormat)
        {
            return
