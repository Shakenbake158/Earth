...
namespace Earth.Renderer
{
    ...
    public static class Device
    {
        ...
        */
        ...
        public static Texture2D CreateTexture2D(TextureFormat bitmap, TextureFormat format, bool generateMipmaps)
        {
        ...
        public static Texture2D CreateTexture2DRectangle(TextureFormat bitmap, TextureFormat format)
        {
            return CreateTexture2DFromBitmap(bitmap, format, false, TextureTarget.TextureRectangle);
        }

        private static Texture2D CreateTexture2DFromBitmap(TextureFormat bitmap, TextureFormat format, bool generateMipmaps, TextureFormat textureTarget)
        {
        ...
        public static TextureFormat CreateBitmapFromText(string text, Font font)
        {
            Texture tmpbitmap = new Texture(1, 1);
        ...
        public static Texture CreateBitmapFromPoint(int radiusInPixels)
        {
            if (radiusInPixels < 1)
            {
            ...
            Texture bitmap = new Texture(diameter, diameter, ImagingPixelFormat.Format32bppArgb);
            Graphics graphics = Graphics.FromImage(bitmap);
            Brush brush = new SolidBrush(Color.White);
