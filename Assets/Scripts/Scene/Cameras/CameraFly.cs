...
namespace Earth.Scene
{
    public class CameraFly : IDisposable
    {
        ...
        public Vector3D Look
        {
            ...
            set { _look = new OpenTK.Mathematics.Vector3d(value.X, value.Y, value.Z); }
        }

        public Vector3D Up
        {
            get { return new Vector3D(_up.X, _up.Y, _up.Z); }
            set { _up = new OpenTK.Mathematics.Vector3d(value.X, value.Y, value.Z); }
        }
        ...
        {
            OpenTK.Mathematics.Quaterniond rotation = OpenTK.Mathematics.Quaterniond.FromAxisAngle(_look, -seconds);

            _up = OpenTK.Mathematics.Vector3d.Transform(_up, rotation);
            _right = OpenTK.Mathematics.Vector3d.Cross(_look, _up);
        ...
        private void Rotate(Size movement)
        {
            ...
            OpenTK.Mathematics.Quaterniond horizontalRotation = OpenTK.Mathematics.Quaterniond.FromAxisAngle(_up, -horizontalWindowRatio);
            OpenTK.Mathematics.Quaterniond verticalRotation = OpenTK.Mathematics.Quaterniond.FromAxisAngle(_right, verticalWindowRatio);

            _look = OpenTK.Mathematics.Vector3d.Transform(_look, horizontalRotation);
            _look = OpenTK.Mathematics.Vector3d.Transform(_look, verticalRotation);
            _up = OpenTK.Mathematics.Vector3d.Transform(_up, horizontalRotation);
            _up = OpenTK.Mathematics.Vector3d.Transform(_up, verticalRotation);
            _right = OpenTK.Mathematics.Vector3d.Cross(_look, _up);
        ...
        public void UpdateParametersFromCamera()
        {
            ...
            _look = new OpenTK.Mathematics.Vector3d(_camera.Forward.X, _camera.Forward.Y, _camera.Forward.Z);
            _up = new OpenTK.Mathematics.Vector3d(_camera.Up.X, _camera.Up.Y, _camera.Up.Z);
            _right = new OpenTK.Mathematics.Vector3d(_camera.Right.X, _camera.Right.Y, _camera.Right.Z);
        }
        ...
        private OpenTK.Mathematics.Vector3d _look;
        private OpenTK.Mathematics.Vector3d _up;
        private OpenTK.Mathematics.Vector3d _right;
